...
def detect_by_vision(
    ...
    try:
        ...
        system_prompt = (
            ...
            "- ATTENTION MULTI-PERSONNES (TRES IMPORTANT) : dans un gym, il y a souvent "
            "PLUSIEURS personnes visibles. Tu DOIS identifier la personne qui FAIT L'EXERCICE. "
            "Indices pour trouver le lifter : "
            "1) C'est la personne qui interagit avec un equipement (barre, machine, halteres, poulie). "
            "2) C'est souvent la personne la plus PROCHE de la camera / au CENTRE du cadre. "
