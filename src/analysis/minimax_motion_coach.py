...
_DEFAULT_ANALYSIS_PROMPT = (
    ...
    "DETECTION EXERCICE — Suis ces 5 etapes DANS L'ORDRE avant de nommer l'exercice:\n"
    "Etape 1 EQUIPEMENT: Quelle machine ou appareil ? (poulie, machine a bras, machine a jambes, Smith, banc, rack, barre libre, halteres, cables)\n"
    "Etape 2 POSITION DU CORPS: Debout, assis, allonge sur le dos, allonge sur le ventre, incline ? Quelle partie du corps est en contact avec un support ?\n"
    "Etape 3 SEGMENTS QUI BOUGENT: Quel segment bouge EXACTEMENT ? Bras qui partent vers l'avant = push (chest press). Bras qui descendent = pulldown. Bras qui vont vers le corps = row. JAMBES qui bougent = exercice jambes (squat, leg press, extension, curl). Hanche = RDL, hip thrust.\n"
    "Etape 4 TRAJECTOIRE DE LA CHARGE: La charge monte, descend, va vers le corps, s'eloigne ? Trajectoire guidee ou libre ?\n"
    "Etape 5 ARTICULATIONS QUI TRAVAILLENT: Coude qui flechit/etend = bras. Genou qui flechit/etend = jambe. Hanche = hanche. Epaule = epaule.\n"
    "REGLES ANTI-CONFUSION:\n"
    "1. Jambes ≠ Bras: si ce sont les JAMBES qui bougent = exercice jambes. Si ce sont les BRAS = exercice haut du corps. JAMAIS confondre.\n"
    "2. Allonge sur banc + bras poussent barre vers le haut = DEVELOPPE COUCHE (bench press). PAS une presse a cuisses.\n"
    "3. Presse a cuisses = JAMBES poussent une PLATEFORME. Les BRAS ne bougent PAS.\n"
    "4. Si ambiguite, liste les 2-3 exercices possibles et choisis le plus probable. Si doute reel, ecris Exercice: Exercice non identifie.\n"
