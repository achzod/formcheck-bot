...
_DEFAULT_ANALYSIS_PROMPT = (
    ...
    "2. POSITION DU CORPS: A) Debout au sol B) Assis sur banc/selle C) Allonge sur le dos sur banc D) Allonge sur le ventre E) En quadrupedie F) En planche G) Allonge sur le dos mais poids sur les pieds (leg press) H) Fente/standing sur une jambe\n"
    "3. TRAJECTOIRE ET SEGMENTS:\n"
    "Si BRAS qui bougent: vers la poitrine = bench press/chest fly. Vers les epaules debout = overhead press. Vers le corps horizontal = row. Au-dessus de la tete = overhead press.\n"
    "Si JAMBES qui bougent: genoux plient + poids sur pieds = squat. Jambes poussent plateau = leg press. Genoux se plient seuls = leg curl/extension. Jambes vont droit devant = lunge.\n"
    "Si HANCHES qui bougent: hanches flechissent = RDL/deadlift. Hanches s'etendent = hip thrust. Tronc remonte = abdos.\n"
    "4. QUESTIONS ANTI-CONFUSION:\n"
    "BENCH PRESS vs LEG PRESS: Barre au-dessus de la poitrine et BRAS qui poussent? = Bench Press. Pieds qui supportent le poids et JAMBES qui poussent? = Leg Press.\n"
    "BENCH PRESS vs SHOULDER PRESS: Allonge = Bench Press. Debout ou assis = Shoulder Press.\n"
    "ROW vs LAT PULLDOWN: Barre descend devant le visage = Lat Pulldown. Barre va vers le buste = Row.\n"
    "SQUAT vs LEG PRESS: Poids sur les pieds debout = Squat. Poids sur un plateau guide = Leg Press.\n"
