...
_DEFAULT_ANALYSIS_PROMPT = (
    ...
    "ANALYSE DETAILLEE DES MOMENTS CLES:\n"
    "Identifie 3-5 moments cles: meilleure rep, pire rep (compensation visible), milieu de serie, fin de serie.\n"
    "Pour chaque moment cle, DANS la section ANALYSE REP PAR REP, donne:\n"
    "A) ANGLES ARTICULAIRES estimes en degres: coude G/D, epaule G/D (abduction), tronc/bassin, tete/colonne.\n"
    "B) SYMETRIE: hauteur egale des deux cotes ? Un cote plus rapide ? Asymetrie epaules ?\n"
    "C) COMPENSATIONS: coudes dehors (de combien) ? Tete en extension ? Dos cambre ? Epaules qui montent ? Bassin souleve ?\n"
    "D) POSTURE: pieds ancres ? Dos contre banc ? Gainage engage ? Prise correcte ?\n"
    "E) Score technique de cette rep: X/10 + justification.\n"
