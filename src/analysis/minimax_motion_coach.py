...
_DEFAULT_ANALYSIS_PROMPT = (
    ...
    "Tu PEUX et DOIS utiliser tes skills pour extraire des frames de la video avec ffmpeg et generer des images annotees. Fais-le AVANT d'ecrire le rapport.\n"
    ...
    "Allonge sur le DOS + BARRE LIBRE au-dessus = Developpe couche (Bench Press)\n"
    "Allonge sur le DOS + POIDS SUR LES PIEDS = Presse a cuisses (Leg Press)\n"
    "Allonge sur le DOS + HALTERES = Developpe halteres\n"
    "Allonge sur le VENTRE = Rowing ou Face Pull\n"
    "Assis = Developpe epaules / Curl / Tricep / Chest Press machine\n"
    "Debout = Squat / Developpe militaire / Souleve de terre\n"
    "ALLONGE DOS + BARRE AU-DESSUS + BRAS QUI POUSSENT = Developpe couche. JAMAIS presse a cuisses.\n"
    "Segment qui bouge: Bras vers la poitrine = Push. Bras vers le corps = Tirage. Jambes qui plient = Squat/Presse. Hanche qui s'ouvre = Hip.\n"
    "Anti-confusion: Developpe couche vs Presse a cuisses: barre au-dessus de la poitrine et BRAS qui poussent = Developpe couche. Pieds qui supportent le poids et JAMBES qui poussent = Presse a cuisses.\n"
    "Si confiance < 85%, donne 2 options avec justification et choisis la plus probable.\n"
    "EXTRACTION ET ANNOTATION DES FRAMES CLES:\n"
    "Utilise ffmpeg pour extraire 3-5 frames cles de la video: meilleure rep, pire rep (compensation visible), milieu de serie, fin de serie.\n"
    "Pour CHAQUE frame extraite, cree une image annotee avec overlay DIRECT sur le screenshot reel:\n"
    "Fleches ROUGES = problemes. VERTES = correct. JAUNES = attention.\n"
    "Angles articulaires en degres (coude, epaule, tronc/bassin). Fleche de trajectoire. Position tete. Alignement dos. Stabilite pieds.\n"
    "Encadre en haut: numero rep, score /10, probleme ou point positif, timestamp.\n"
    "Analyse pour chaque frame:\n"
    "A) ANGLES: coude G/D, epaule G/D, tronc/bassin, tete/colonne.\n"
    "B) SYMETRIE: hauteur egale ? Un cote plus rapide ? Asymetrie epaules ?\n"
    "C) COMPENSATIONS: coudes dehors ? Tete en extension ? Dos cambre ? Epaules qui montent ? Bassin souleve ?\n"
    "D) POSTURE: pieds ancres ? Dos contre banc ? Gainage ? Prise correcte ?\n"
    "E) Score technique: X/10 + justification.\n"
    "Fais les frames AVANT le rapport. Integre l'analyse dans ANALYSE REP PAR REP.\n"
    "Ne presume JAMAIS unilateral sauf si tu vois clairement un seul bras ou une seule jambe travailler. Par defaut, l'exercice est bilateral.\n"
    "Si le doute est reel, mets Exercice: Exercice non identifie et Exercice slug: unknown.\n"
    "Le score global doit etre coherent avec les 4 sous-scores. Securite max 40, Efficacite max 30, Controle max 20, Symetrie max 10. Ne depasse JAMAIS ces maximums.\n"
    ...
    "REGLES STRICTES:\n"
    "- Chaque section DOIT avoir du contenu. JAMAIS de section vide.\n"
    "- JAMAIS de section dupliquee. Chaque section apparait UNE SEULE FOIS.\n"
    "- Le score global DOIT etre egal a la somme des 4 sous-scores. Verifie avant d'ecrire.\n"
    "- Securite 0/40 est INTERDIT sauf si l'exercice est reellement dangereux (blessure imminente). Minimum 15/40 pour une execution normale.\n"
    "- Pour chaque observation, explique l'impact biomecanique (muscle, articulation, progression, risque blessure).\n"
    "- CHAQUE section listee ci-dessous DOIT contenir du texte. Si tu ecris un titre de section, tu DOIS ecrire du contenu en dessous. Une section vide = rapport INVALIDE.\n"
    "## RESUME\n"
    "## POINTS POSITIFS\n"
    "OBLIGATOIRE: liste au moins 3 points positifs concrets observes dans la video (stabilite, amplitude, symetrie, controle excentrique, calage, trajectoire, etc.). Cette section ne peut JAMAIS etre vide.\n"
    ...
    "## INTENSITE DE SERIE\n"
    "Estime le pourcentage de 1RM, le RPE, et l'impact sur la recuperation. Minimum 3 phrases.\n"
    "## COMPENSATIONS ET BIOMECANIQUE AVANCEE\n"
    "IMPORTANT: N'utilise JAMAIS de tirets (- ou --) comme separateurs ou puces. Utilise des numeros (1. 2. 3.) ou des paragraphes.\n"
    "## DECOMPOSITION DU SCORE\n"
    "Tu DOIS ecrire EXACTEMENT ces 4 lignes dans cet ordre, chacune suivie de sa justification:\n"
    "Securite: XX/40 - justification\n"
    "Efficacite technique: XX/30 - justification\n"
    "Controle et tempo: XX/20 - justification\n"
    "Symetrie: XX/10 - justification\n"
    "INTERDIT d'en oublier un. Si tu n'ecris pas les 4, le rapport est INVALIDE. Verifie que la somme = Score global.\n"
    "## POINT BIOMECANIQUE\n"
    "Explique un concept biomecanique cle lie a cet exercice. Minimum 3 phrases.\n"
