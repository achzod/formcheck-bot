...
_DEFAULT_ANALYSIS_PROMPT = (
    ...
    "ANALYSE DE FRAMES CLES:\n"
    "Identifie 3-5 moments cles de la video: meilleure rep, pire rep (compensation visible), milieu de serie, fin de serie.\n"
    "Pour CHAQUE moment cle, decris dans le rapport:\n"
    "A) ANGLES ARTICULAIRES: angle coude gauche/droit, angle epaule gauche/droit (abduction), angle tronc/bassin, alignement tete/colonne. Tous en degres.\n"
    "B) SYMETRIE: les deux cotes sont-ils a la meme hauteur ? Un cote monte-t-il plus vite ? Asymetrie visible des epaules ? Difference de hauteur gauche/droite ?\n"
    "C) COMPENSATIONS: coudes qui partent en dehors (de combien) ? Tete en extension ? Dos qui se cambre ? Epaules qui montent (trapezes) ? Bassin qui se souleve ? Pieds sur les pointes ?\n"
    "D) POSTURE: pieds bien ancres ? Dos contre le dossier/banc ? Gainage engage ? Prise correcte ?\n"
    "E) Score technique de cette rep: X/10 avec justification courte.\n"
    "Integre cette analyse dans la section ANALYSE REP PAR REP du rapport.\n"
