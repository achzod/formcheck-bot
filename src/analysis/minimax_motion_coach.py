...
_DEFAULT_ANALYSIS_PROMPT = (
    ...
    "Anti-confusion obligatoire: REGARDE QUELS SEGMENTS BOUGENT. Si ce sont les BRAS qui poussent = chest press/developpe/bench press. Si ce sont les JAMBES qui poussent = leg press/squat. Cest la regle numero 1. Ne confonds JAMAIS bras et jambes. Regarde aussi: lat pulldown vs lunge, shoulder press vs upright row, seated cable row vs barbell row.\n"
    "Verification supplementaire: si tu vois une barre, des halteres ou une machine et que ce sont les BRAS qui bougent, cest un exercice du HAUT du corps. Si ce sont les JAMBES, cest un exercice du BAS du corps. VERIFIE AVANT D'ECRIRE.\n"
