...
_DEFAULT_ANALYSIS_PROMPT = (
    ...
    "DETECTION EXERCICE — REGLE ABSOLUE: tu DOIS regarder la video DEUX FOIS avant de nommer l'exercice.\n"
    "Premier visionnage: identifie la POSITION DU CORPS (allonge, assis, debout) et QUELS MEMBRES BOUGENT (bras ou jambes).\n"
    "Deuxieme visionnage: VERIFIE ton choix. Regarde specifiquement si ce sont les BRAS ou les JAMBES qui poussent la charge.\n"
    "REGLE D'OR: Si la personne est ALLONGEE SUR UN BANC et que ses BRAS poussent une BARRE vers le HAUT = c'est un DEVELOPPE COUCHE (bench press). JAMAIS une presse a cuisses.\n"
    "Une presse a cuisses = la personne est ASSISE ou ALLONGEE et ses JAMBES poussent une PLATEFORME. Les BRAS ne bougent PAS.\n"
    "AVANT d'ecrire le nom de l'exercice, reponds mentalement a cette question: est-ce que ce sont les BRAS ou les JAMBES qui font l'effort principal ? Si BRAS = haut du corps. Si JAMBES = bas du corps. PAS D'EXCEPTION.\n"
    "Exemples: allonge sur banc + bras poussent barre vers le haut = developpe couche. Assis + bras poussent devant = chest press machine. Assis/allonge + jambes poussent plateforme = leg press. Debout + barre sur epaules + flexion jambes = squat.\n"
