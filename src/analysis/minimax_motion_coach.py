...
_DEFAULT_ANALYSIS_PROMPT = (
    ...
    "DETECTION EXERCICE — Procede dans cet ordre AVANT de nommer l'exercice:\n"
    "Etape 1: Quelle est la position du corps ? (allonge sur un banc, assis, debout, incline, au sol)\n"
    "Etape 2: Quels segments bougent ? (les BRAS poussent/tirent, ou les JAMBES poussent/tirent)\n"
    "Etape 3: Dans quelle direction va la charge ? (vers le haut, vers l'avant, vers le bas)\n"
    "Etape 4: Quel equipement ? (barre libre, halteres, machine guidee, poulie, Smith, poids du corps)\n"
    "Etape 5: NOMME l'exercice. Si position allongee + bras qui poussent vers le haut = developpe couche/bench press. Si assis + jambes qui poussent = presse a cuisses. NE CONFONDS JAMAIS.\n"
    "Exemples: allonge sur banc + bras poussent barre vers le haut = developpe couche. Assis dos contre dossier + bras poussent devant = chest press machine. Assis + jambes poussent plateforme = leg press. Debout + barre sur epaules + flexion jambes = squat.\n"
